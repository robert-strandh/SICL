...
program and $N$ is the number of elements of the set $S$.  Two pairs
can now be compared using a \emph{lexicographic order} , so that for
two pairs $(B_1,N_1)$ and $(B_2,N_2)$, $(B_1,N_1)$ is \emph{strictly
