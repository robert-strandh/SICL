...
\cplusplus{} whereas most of the \commonlisp{} code has been included
with no modification, including the code for the \texttt{loop} macro.
...
non-conforming examples shown in \refSec{sec-mit-loop} are also accepted
by \sbcl{}.
