...
There are several ways in which we can create an installed
discriminating function into \texttt{compute-discriminating-function}
in environment N.  One simple way is to just call it, passing it any
generic function in either environment N or environment N+1.  The
