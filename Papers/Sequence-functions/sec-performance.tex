...
In the next test, the sequence is a list of pairs
of symbols; it uses  \texttt{car} as key function, \texttt{eq} as test
function  and a non \texttt{nil} value for the \texttt{end}
parameter. Our implementation is at least twice as fast as \sbcl{}.

\texttt{verify add description of test}
