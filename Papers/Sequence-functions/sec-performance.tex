...
of symbols; it uses  \texttt{car} as key function, \texttt{eq} as test function  and a non \texttt{nil} value for the \texttt{end} parameter. Our implementation is at least twice as fast as
\texttt{sbcl}.
