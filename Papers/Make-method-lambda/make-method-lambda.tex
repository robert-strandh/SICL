...
\begin{abstract}
The \commonlisp{} \cite{ansi:common:lisp} metaobject protocol
\cite{Kiczales:1991:AMP:574212} specifies a generic function named
\mml{} to be called at macro-expansion time of the macro
\texttt{defmethod}.  In an article by \cnh{} \cite{Constanza:2008}, a
number of problems with this generic function are discussed, and a
