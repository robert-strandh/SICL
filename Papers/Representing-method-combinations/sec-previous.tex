...
whenever a generic function is created.  Furthermore,
\texttt{compute-effective-method} has a method specialized to the
class \texttt{short-method-combination} that handles the case of the
short method combination as a special case.
...
using the method-combination type as a key.
