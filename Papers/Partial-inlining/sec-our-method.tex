...
as part of the worklist items.

Initially, the remaining work has the value $r_0 = (N,1)$ where $N$ is
the number of instructions in the called function.  We consider values
as being lexical, i.e. $(I_1, F_1) < (I_2, F_2)$ if and only if either
