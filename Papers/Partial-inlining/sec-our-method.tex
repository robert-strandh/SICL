...
\item If the next instruction has a single successor, insert a copy of
  ...
  the inputs of the \texttt{funcall} instruction and the outputs of
  the \texttt{enter} instruction as described below.
\item If the next instruction has two successors, insert a copy of the
  ...
  inputs of the \texttt{funcall} instruction and the outputs of the
  \texttt{enter} instruction as described below.
\end{enumerate}
