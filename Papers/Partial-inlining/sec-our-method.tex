...
\item The mappings and ownership information described previously.
\end{itemize}
...
For rules $3$ and $4$, when a new instruction is inlined, the mapping,
...
in our mapping.  Therefore, a temporary variable \texttt{ww} is
created in the calling function, and an entry is created in the
mapping that translates \texttt{w} to \texttt{ww}.  The private
