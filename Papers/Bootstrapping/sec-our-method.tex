...
required in phase $1$ are imported.  Classes {\small\texttt{standard-method},
\texttt{standard-generic-function}}, and the class used to represent
slots
{\small \texttt{standard-direct-slot-definition}} are imported with the
same.  Classes {\small\texttt{standard-class}, \texttt{built-in-class}}, and
{\small\texttt{funcallable-standard-class}} in environment $E_0$ all
refer to one and the same host class, namely a subclass of the host
class
{\small\texttt{funcallable-standard-class}}.
