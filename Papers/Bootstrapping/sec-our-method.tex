...
The resulting intermediate code is then translated to a simple subset
of \commonlisp{} code that accesses that same environment for
definitions of functions and other objects.  This \commonlisp{} code
is then compiled using the host compiler in order to make it
...
\begin{definition}
A \emph{simple instance} is an instance of some class that is
neither a class nor a generic function itself.
\end{definition}
