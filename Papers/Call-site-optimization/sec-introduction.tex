...
Item number 4 can be mitigated by the use of more than one entry point
for functions, one of which would accept unboxed arguments.  This
technique is used by Allegro Common Lisp%
