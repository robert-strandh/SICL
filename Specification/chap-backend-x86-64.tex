...
transferred is responsible for adjusting esp to a particular value
relative to \texttt{RBP}.
...
dynamic environment is traversed again and thunks in UNWIND-PROTECT
entries are executed.  The traversal again stops when the stack frame
of the valid exit point is reached.
