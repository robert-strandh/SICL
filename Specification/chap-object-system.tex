...
is tested in the order determined by the \emph{argument precedence
  order} of the generic function.  For each argument, the set of
possible effective methods is filtered by a binary search, eliminating
around half of the possibilities in each comparison.
...
The object class unique numbers are then used by the automaton to find
