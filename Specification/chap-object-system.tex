...
The final step in this phase is to \emph{install} all remaining bridge
generic functions so that they are the \texttt{fdefinition}s of their
respective names. 

At the end of this phase, we have a complete set of bridge generic
functions that operate on target instances (including on target
classes). 
