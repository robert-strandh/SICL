...
\begin{itemize}
\item A linkage rack containing external objects that the running
  code needs to access.
\item A code vector which is a byte vector of machine-code instructions.  
...
\item An offset into the code vector in the code object.  That offset
