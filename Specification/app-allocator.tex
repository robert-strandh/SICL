...
free.  To obtain the size of the chunk in bytes, the last two bits of
...
the end of the bin.  By using these sentinels, the algorithms for
linking and unlinking a chunk are simplified.  The last word of a
