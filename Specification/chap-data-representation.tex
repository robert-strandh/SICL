...
the heap object as it was when the heap object was created.  The main
...
obsolete. \seesec{sec-data-representation-standard-objects}

One advantage of representing heap objects this way is that the
...
\emph{object class unique
  number}). \seesec{sec-data-representation-other-heap-objects} 
...
\refSec{sec-data-representation-other-heap-objects}, in order to
