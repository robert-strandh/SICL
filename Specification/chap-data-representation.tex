...
of the class \texttt{standard-object}.
...
generic function.  Transferring control to the discriminating function
therefore requires access to the generic function \emph{instance}.  We
accomplish this access by storing a reference to the generic function
instance in the \emph{static environment} of the generic function
object.

As a consequence, every generic function contains the same code vector
and the same entry point; only the static environment differs.  
