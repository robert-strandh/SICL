...
\item A hash table mapping a value of the program counter to a
  ...
  function could use the register.  If the current function did not
  save the register, the corresponding entry contains some default
  value ($0$) indicating this fact.  For a typical backend such as
