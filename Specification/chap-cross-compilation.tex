...
topics, see \refChap{chap-compiler}.  A cross compiler must necessary
create some external representation, like  a \emph{file}, containing
the result of the compilation, and that file must be readable on the
target system.  Most often, it will be the \emph{fasl} format of the
target.
