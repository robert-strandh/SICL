...
caller puts the linkage vector in this register, and then calls the
...
correct linkage vector.  Notice that the linkage vector is a
disembodied contents vector.  When a function A calls a function B, if
