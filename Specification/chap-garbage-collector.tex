...
we change the color of either one of the two gray.  The choice can be
based on the type of objects in question, or it can be a global
...
\section{Synchronization between nursery and global collectors}
