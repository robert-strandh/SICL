...
interested in.  That return address is used to access the \emph{frame
  map} as described in \refSec{data-representation-code-objects}.
Recall that the \emph{frame map} is a bitmap that contains an element
for each stack location containing a \commonlisp{} object that might
be heap allocated.
