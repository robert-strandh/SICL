...
\refSec{sec-garbage-collection-finding-roots}.  Only pointers to
...
may contain live object of the rack are recursively visited, the
...
by the bit in the live bitmap, and an object is skipped if it
