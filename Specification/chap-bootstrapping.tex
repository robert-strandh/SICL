...
In addition to the host environment, five different \sysname{}
first-class environments are involved in the bootstrapping procedure.
We shall refer to them as $E_0$, $E_1$, $E_2$, $E_3$, and $E_4$.

\subsubsection{Phase 0}

We define a class named \texttt{sicl-boot-phase-0:funcallable-standard-class}
in the host environment.  When we evaluate \texttt{defclass} forms in
phase 1, the classes created are instances of this class.
