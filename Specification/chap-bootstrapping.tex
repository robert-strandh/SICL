...
method that corresponds to the arguments of the call, and if no
effective method can be found, calls the machinery to compute the
effective method and adds the new effective method to the call history.
