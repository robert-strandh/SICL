...
\texttt{target:unique-number} is called to determine the unique
number of the class.
\end{definition}
...
call, and \texttt{target:unique-number} is called to determine the
...
as \texttt{target:unique-number} must be defined in that context to
