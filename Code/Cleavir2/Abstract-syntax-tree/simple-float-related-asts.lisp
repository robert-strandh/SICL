...
(defmacro define-simple-one-arg-float-ast (name)
  `(progn 
     (defclass ,name (ast one-value-ast-mixin dynamic-environment-input-ast-mixin)
...
(defclass coerce-ast (ast one-value-ast-mixin dynamic-environment-input-ast-mixin)
