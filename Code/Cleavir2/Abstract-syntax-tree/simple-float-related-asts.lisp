...
(defmacro define-simple-one-arg-float-ast (name)
  `(progn 
     (defclass ,name (ast dynamic-environment-input-ast-mixin one-value-ast-mixin)
...
(defclass coerce-ast (ast dynamic-environment-input-ast-mixin one-value-ast-mixin)
