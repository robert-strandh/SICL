...
(defmethod convert-let (client cst lexical-environment dynamic-environment-ast)
  ...
  (cst:db origin (let-cst bindings-cst . body-forms-cst) cst
    ...
    (let* ((binding-csts (cst:listify bindings-cst))
      ...
      (convert client lambda-form-cst lexical-environment dynamic-environment-ast))))
                                      ...
                                      (if (null declaration-cst)
                                          ...
                                          (list (cst:cstify
                                                 (cons
                                                  ...
                                                  declaration-cst))
                                                result))))))
                finally (return (convert client result lexical-environment dynamic-environment-ast))))))))
