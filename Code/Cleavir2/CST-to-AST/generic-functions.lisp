...
(defgeneric convert-code (client lambda-list body-cst lexical-environment dynamic-environment-ast &key block-name-cst))
...
(defgeneric convert-let (client cst lexical-environment dynamic-environment-ast))
