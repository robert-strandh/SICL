...
\subsubsection{\texttt{slot-read-ast}}
...
\subsubsection{\texttt{cell-read-ast}}
\label{sec-ast-cell-read}
...
\begin{tabular}{|l|l|l|}
  ...
  \hline\hline
  \texttt{:object-ast} & \texttt{object-ast} & The AST for the object.\\
  \texttt{:cell-number-ast} & \texttt{cell-number-ast} & The AST for
  the cell number.\\
  \hline
\end{tabular}

This AST can be used to read a cell of a standard object.

\subsubsection{\texttt{cell-write-ast}}
\label{sec-ast-cell-write}
...
This AST can be used to write a cell of a standard object.
