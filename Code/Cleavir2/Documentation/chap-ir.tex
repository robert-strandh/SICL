...
\subsection{Instruction \texttt{cell-read-instruction}}
\label{hir-instruction-cell-read}
...
reason, \emph{safe} code should have additional instructions inserted
to ensure that this condition is respected.  The second input is a
non-negative fixnum indicating the \emph{index} of the cell in the
instance.  The output is the contents of the corresponding cell.

\subsection{Instruction \texttt{cell-write-instruction}}
\label{hir-instruction-cell-write}
...
reason, \emph{safe} code should have additional instructions inserted
to ensure that this condition is respected.  The second input is a
fixnum indicating the \emph{index} of the cell in the instance.  The
third input can be any object.  The effect of the instruction is to
replace the contents of the corresponding cell by the third input.
