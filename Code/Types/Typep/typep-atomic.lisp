           ...
           (case type-specifier
             ...
             (class
              (let ((object-class (class-of object)))
                ...
                ;; the object.
                (if (member (sicl-environment:find-class client global-environment 'class)
                            (sicl-clos:class-precedence-list object-class))
                    t nil)))
             (otherwise
              (let ((expander (sicl-environment:type-expander client global-environment type-specifier))
                    (type-class (sicl-environment:find-class client global-environment type-specifier)))
