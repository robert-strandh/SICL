...
(defun intersection-identity-eql (name list1 list2)
  (let ((result '()))
    (with-proper-list-elements (element1 list1 name)
      (when (with-proper-list-elements (element2 list2 name)
	      (when (eql element1 element2)
		(return t)))
	(push element1 result)))
    result))
...
(defun intersection-key-eql (name list1 list2 key)
  (let ((result '()))
    (with-proper-list-elements (element1 list1 name)
      (when (with-proper-list-elements (element2 list2 name)
	      (when (eql (funcall key element1) (funcall key element2))
		(return t)))
	(push element1 result)))
    result))
...
(defun intersection-key-eq (name list1 list2 key)
  (let ((result '()))
    (with-proper-list-elements (element1 list1 name)
      (when (with-proper-list-elements (element2 list2 name)
	      (when (eq (funcall key element1) (funcall key element2))
		(return t)))
	(push element1 result)))
    result))
...
(defun intersection-identity-test (name list1 list2 test)
  (let ((result '()))
    (with-proper-list-elements (element1 list1 name)
      (when (with-proper-list-elements (element2 list2 name)
	      (when (funcall test element1 element2)
		(return t)))
	(push element1 result)))
    result))
...
(defun intersection-key-test (name list1 list2 key test)
  (let ((result '()))
    (with-proper-list-elements (element1 list1 name)
      (when (with-proper-list-elements (element2 list2 name)
	      (when (funcall test (funcall key element1) (funcall key element2))
		(return t)))
	(push element1 result)))
    result))
...
(defun intersection-identity-test-not (name list1 list2 test-not)
  (let ((result '()))
    (with-proper-list-elements (element1 list1 name)
      (when (with-proper-list-elements (element2 list2 name)
	      (unless (funcall test-not element1 element2)
		(return t)))
	(push element1 result)))
    result))
...
(defun intersection-key-test-not (name list1 list2 key test-not)
  (let ((result '()))
    (with-proper-list-elements (element1 list1 name)
      (when (with-proper-list-elements (element2 list2 name)
	      (unless (funcall test-not (funcall key element1) (funcall key element2))
		(return t)))
	(push element1 result)))
    result))
