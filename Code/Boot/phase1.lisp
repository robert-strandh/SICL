...
(defun create-mop-classes-phase1 (boot)
  (let ((r2 (r2 boot)))
    ...
    (ld "../CLOS/standard-object-defclass.lisp" r2 r2)
    (ld "../CLOS/metaobject-defclass.lisp" r2 r2)
    (ld "../CLOS/method-defclass.lisp" r2 r2)
    (ld "../CLOS/standard-method-defclass.lisp" r2 r2)
    (ld "../CLOS/standard-accessor-method-defclass.lisp" r2 r2)
    (ld "../CLOS/standard-reader-method-defclass.lisp" r2 r2)
    (ld "../CLOS/standard-writer-method-defclass.lisp" r2 r2)
    (ld "../CLOS/slot-definition-defclass.lisp" r2 r2)
    (ld "../CLOS/standard-slot-definition-defclass.lisp" r2 r2)
    (ld "../CLOS/direct-slot-definition-defclass.lisp" r2 r2)
    ...
    (ld "../CLOS/simple-method-combination-defclass.lisp" r2 r2)
    ...
    (ld "../CLOS/class-defclass.lisp" r2 r2)
    (ld "../CLOS/forward-referenced-class-defclass.lisp" r2 r2)
    (ld "../CLOS/real-class-defclass.lisp" r2 r2)
    (ld "../CLOS/regular-class-defclass.lisp" r2 r2)
    (ld "../CLOS/standard-class-defclass.lisp" r2 r2)
    (ld "../CLOS/funcallable-standard-class-defclass.lisp" r2 r2)
    (ld "../CLOS/built-in-class-defclass.lisp" r2 r2)
    (ld "../CLOS/funcallable-standard-object-defclass.lisp" r2 r2)
    (ld "../CLOS/generic-function-defclass.lisp" r2 r2)
    (ld "../CLOS/standard-generic-function-defclass.lisp" r2 r2)))
