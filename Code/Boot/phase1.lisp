...
(defun create-mop-classes-phase1 ()
  (let ((env *phase1-mop-class-env*))
    (create-exceptional-mop-classes-phase1 env)
    (define-ensure-class env env env)
    (define-funcallable-standard-class)
    (ld "../CLOS/standard-object-defclass.lisp" env env)
    (ld "../CLOS/metaobject-defclass.lisp" env env)
    (ld "../CLOS/method-defclass.lisp" env env)
    (ld "../CLOS/standard-method-defclass.lisp" env env)
    (ld "../CLOS/standard-accessor-method-defclass.lisp" env env)
    (ld "../CLOS/standard-reader-method-defclass.lisp" env env)
    (ld "../CLOS/standard-writer-method-defclass.lisp" env env)
    (ld "../CLOS/slot-definition-defclass.lisp" env env)
    (ld "../CLOS/standard-slot-definition-defclass.lisp" env env)
    (ld "../CLOS/direct-slot-definition-defclass.lisp" env env)
    (ld "../CLOS/effective-slot-definition-defclass.lisp" env env)
    (ld "../CLOS/standard-direct-slot-definition-defclass.lisp" env env)
    (ld "../CLOS/standard-effective-slot-definition-defclass.lisp" env env)
    (ld "../CLOS/method-combination-defclass.lisp" env env)
    (ld "../CLOS/simple-method-combination-defclass.lisp" env env)
    (ld "../CLOS/specializer-defclass.lisp" env env)
    (ld "../CLOS/eql-specializer-defclass.lisp" env env)
    (ld "../CLOS/class-unique-number-defparameter.lisp" env env)
    (ld "../CLOS/class-defclass.lisp" env env)
    (ld "../CLOS/forward-referenced-class-defclass.lisp" env env)
    (ld "../CLOS/real-class-defclass.lisp" env env)
    (ld "../CLOS/regular-class-defclass.lisp" env env)
    (ld "../CLOS/standard-class-defclass.lisp" env env)
    (ld "../CLOS/funcallable-standard-class-defclass.lisp" env env)
    (ld "../CLOS/built-in-class-defclass.lisp" env env)
    (ld "../CLOS/funcallable-standard-object-defclass.lisp" env env)
    (ld "../CLOS/generic-function-defclass.lisp" env env)
    (ld "../CLOS/standard-generic-function-defclass.lisp" env env)))
