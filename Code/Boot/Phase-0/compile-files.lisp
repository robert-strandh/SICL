...
(defun compile-files (client environment)
  (flet ((cf (name)
    ...
    (cf "CLOS/direct-slot-definition-class-support.lisp")
    (cf "CLOS/direct-slot-definition-class-defgeneric.lisp")
    (cf "CLOS/direct-slot-definition-class-defmethods.lisp")
    ...
    (cf "CLOS/ensure-generic-function-defun.lisp")
    (cf "CLOS/ensure-generic-function-using-class-support.lisp")
    (cf "CLOS/ensure-generic-function-using-class-defgenerics.lisp")
    (cf "CLOS/ensure-generic-function-using-class-defmethods.lisp")
    (cf "CLOS/defgeneric-support.lisp")
    (cf "CLOS/defgeneric-defmacro.lisp")
    (cf "CLOS/defmethod-support.lisp")
    (cf "CLOS/defmethod-defmacro.lisp")
    ...
    (cf "Printer/print-object-defgeneric.lisp")
    (cf "Printer/print-object-defmethod-t.lisp")
    (cf "Printer/print-object-defmethod-integer.lisp")
    (cf "Printer/print-object-defmethod-ratio.lisp")
    (cf "Printer/print-object-defmethod-symbol.lisp")
    (cf "Printer/print-object-defmethod-cons.lisp")
    (cf "Printer/print-object-defmethod-standard-object.lisp")
    (cf "Printer/print-object-defmethod-function.lisp")
    (cf "Printer/print-object-defmethod-class.lisp")
    (cf "Printer/print-object-defmethod-generic-function.lisp")))
