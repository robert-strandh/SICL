...
(defun create-mop-classes (boot)
  (with-accessors ((e5 sicl-boot:e5))
    ...
    (load-fasl "CLOS/simple-function-defclass.fasl" e5)
    ...
    (load-fasl "Cons/null-defclass.fasl" e5)
    ...
    (load-fasl "Character/character-defclass.fasl" e5)
    (load-fasl "Compiler/Code-object/code-object-defclass.fasl" e5)))
