...
(defun enable-defmethod-in-e4 (boot)
  (with-accessors ((e3 sicl-boot:e3)
    ...
    (load-file "CLOS/make-method-for-generic-function.lisp" e3)
    ...
    (load-file "CLOS/defmethod-support.lisp" e4)
    (load-file "CLOS/defmethod-defmacro.lisp" e4)))
