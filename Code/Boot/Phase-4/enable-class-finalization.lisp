...
;;; functions in E5, and ersatz classes in E4.  In other words, we are
...
(defun define-effective-slot-definition-class (boot)
  (with-accessors ((e2 sicl-boot:e2)
    ...
    (load-file "CLOS/effective-slot-definition-class-support.lisp" e3)
    (load-file "CLOS/effective-slot-definition-class-defgeneric.lisp" e3)
...
(defun define-class-finalization (boot)
  (with-accessors ((e3 sicl-boot:e3)) boot
    ...
    (load-file "CLOS/class-finalization-support.lisp" e3)
