...
(defun load-arithmetic-functions (e5)
  ...
  (load-source "Arithmetic/logorc1-defun.lisp" e5)
  (load-source "Arithmetic/logorc2-defun.lisp" e5)
  (load-source "Arithmetic/numberp-defgeneric.lisp" e5)
  (load-source "Arithmetic/realp-defgeneric.lisp" e5)
  (load-source "Arithmetic/floor-defun.lisp" e5)
  (load-source "Arithmetic/ceiling-defun.lisp" e5)
