...
(defmethod translate :around (client instruction context)
  (let ((visited (visited context))
        (tags (tags context)))
    ;; Make sure INSTRUCTION and all of its successors have a tag
    (unless (gethash instruction tags)
      (setf (gethash instruction tags) (gensym)))
    (loop for successor in (cleavir-ir:successors instruction)
          do (unless (gethash successor tags)
               (setf (gethash successor tags) (gensym))))
