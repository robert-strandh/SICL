...
(define-simple-check cleavir-primop:short-float-sub 2)
(define-simple-check cleavir-primop:short-float-mul 2)
(define-simple-check cleavir-primop:short-float-div 2)
(define-simple-check cleavir-primop:single-float-add 2)
(define-simple-check cleavir-primop:single-float-sub 2)
(define-simple-check cleavir-primop:single-float-mul 2)
(define-simple-check cleavir-primop:single-float-div 2)
(define-simple-check cleavir-primop:double-float-add 2)
(define-simple-check cleavir-primop:double-float-sub 2)
(define-simple-check cleavir-primop:double-float-mul 2)
(define-simple-check cleavir-primop:double-float-div 2)
(define-simple-check cleavir-primop:long-float-add 2)
(define-simple-check cleavir-primop:long-float-sub 2)
(define-simple-check cleavir-primop:long-float-mul 2)
(define-simple-check cleavir-primop:long-float-div 2)
(define-simple-check cleavir-primop:short-float-less 2)
(define-simple-check cleavir-primop:short-float-not-greater 2)
(define-simple-check cleavir-primop:short-float-equal 2)
(define-simple-check cleavir-primop:short-float-not-less 2)
(define-simple-check cleavir-primop:short-float-greater 2)
(define-simple-check cleavir-primop:single-float-less 2)
(define-simple-check cleavir-primop:single-float-not-greater 2)
(define-simple-check cleavir-primop:single-float-equal 2)
(define-simple-check cleavir-primop:single-float-not-less 2)
(define-simple-check cleavir-primop:single-float-greater 2)
(define-simple-check cleavir-primop:double-float-less 2)
(define-simple-check cleavir-primop:double-float-not-greater 2)
(define-simple-check cleavir-primop:double-float-equal 2)
(define-simple-check cleavir-primop:double-float-not-less 2)
(define-simple-check cleavir-primop:double-float-greater 2)
(define-simple-check cleavir-primop:long-float-less 2)
(define-simple-check cleavir-primop:long-float-not-greater 2)
(define-simple-check cleavir-primop:long-float-equal 2)
(define-simple-check cleavir-primop:long-float-not-less 2)
(define-simple-check cleavir-primop:long-float-greater 2)
