...
consequences are undefined if this is not the case; \emph{safe}
code should have additional instructions inserted to ensure it.
The output is the contents of the \texttt{car} of the \texttt{cons}
cell.
...
consequences are undefined if this is not the case; \emph{safe}
code should have additional instructions inserted to ensure it.
The output is the contents of the \texttt{cdr} of the \texttt{cons}
cell.
...
The first input to this instruction must be a \texttt{cons} cell.
The consequences are undefined if this is not the case; \emph{safe}
code should have additional instructions inserted to ensure it.
The second input can be any object.  The effect of the instruction
is to replace the contents of the \texttt{car} of the \texttt{cons}
cell by the second input.
...
code should have additional instructions inserted to ensure it.
The second input can be any object.  The effect of the instruction
is to replace the contents of the \texttt{cdr} of the \texttt{cons}
cell by the second input.
...
The consequences are undefined if this is not the case; \emph{safe}
code should have additional instructions inserted to ensure it.
The second input is a non-negative fixnum indicating the \emph{index}
of the slot in the instance.  The output is the contents of the
corresponding slot.
...
The consequences are undefined if this is not the case; \emph{safe}
code should have additional instructions inserted to ensure it.
The second input is a fixnum indicating the \emph{index} of the slot
in the instance.  The third input can be any object.  The effect of
the instruction is to replace the contents of the corresponding
slot by the third input.
...
not the case; safe code should insert additional instructions to
ensure it. The second input is a non-negative fixnum indicating the
\emph{row-major index} of an element of the array.  The output is
the contents of the corresponding element of the array.
...
The inputs to this instruction must be of type \emph{unboxed single
  float}. The output is also of type unboxed single float.
...
The inputs to this instruction must be of type \emph{unboxed double
  float}. The output is also of type unboxed double float.
...
The inputs to this instruction must be of type \emph{unboxed long
  float}. The output is also of type unboxed long float.
