...
The value of a form with this operation is the \emph{sine} of the
argument.
...
The value of a form with this operation is the \emph{cosine} of the
argument.
...
The value of a form with this operation is the \emph{square root} of
the argument.
