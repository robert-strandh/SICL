...
The primitive operation \texttt{consp} is deprecated.  The same
semantics can be expressed with the \texttt{typeq} primitive
operation, using \texttt{cons} as the second argument.
