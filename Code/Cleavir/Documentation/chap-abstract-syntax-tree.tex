...
To combine the two, we find a suffix of $P$, say ((x$_{k_p}$
. y$_{k_p}$) $\cdots$ (x$_{m_p}$ . y$_{m_p}$)) such that x$_{k_p} \ge $
x$_{n_q}$.
...
((x$_{k_p}$ . y$_{k_p}$) $\cdots$ (x$_{m_p}$ . y$_{m_p}$)).  This is
...
profile is represented by $R = $ ((x$_{1_q}$ . y$_{1_q}$$+$y$_{k_p}$)
(x$_{2_q}$ . y$_{2_q}$$+$y$_{k_p}$) $\cdots$ (x$_{m_p}$
. y$_{n_q}$$+$y$_{k_p}$)).
