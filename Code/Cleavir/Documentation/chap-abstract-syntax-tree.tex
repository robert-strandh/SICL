...
. y$_{m_p}$)) and we search for the first points $j>i$ and $j+1$ such
that y$_{{j+1}_p}$$>$y$_{n_q}$.  Two points like this must exist,
because the suffix already contains at least two points, and we know
that y$_{m_p}$ $>$ y$_{n_q}$.  This case is illustrated in
