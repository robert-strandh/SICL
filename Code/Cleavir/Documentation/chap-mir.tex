...
\refFig{fig-shf-+-instruction} shows the Graphviz illustration of the
\texttt{shf-+-instruction}

\begin{figure}
\begin{center}
\inputfig{fig-shf+-instruction.pdf_t}
\end{center}
...
\begin{figure}
\begin{center}
\inputfig{fig-shf-mul-instruction.pdf_t}
\end{center}
\caption{\label{fig-shf-*-instruction}
\texttt{shf-*-instruction}.}
\end{figure}
...
\begin{figure}
\begin{center}
\inputfig{fig-shf-div-instruction.pdf_t}
\end{center}
\caption{\label{fig-shf-/-instruction}
\texttt{shf-/-instruction}.}
\end{figure}
...
\refFig{fig-sf-+-instruction} shows the Graphviz illustration of the
\texttt{sf-+-instruction}

\begin{figure}
\begin{center}
\inputfig{fig-sf+-instruction.pdf_t}
\end{center}
...
\begin{figure}
\begin{center}
\inputfig{fig-sf-mul-instruction.pdf_t}
\end{center}
\caption{\label{fig-sf-*-instruction}
\texttt{sf-*-instruction}.}
\end{figure}
...
\begin{figure}
\begin{center}
\inputfig{fig-sf-div-instruction.pdf_t}
\end{center}
\caption{\label{fig-sf-/-instruction}
\texttt{sf-/-instruction}.}
\end{figure}
...
\refFig{fig-df-+-instruction} shows the Graphviz illustration of the
\texttt{df-+-instruction}

\begin{figure}
\begin{center}
\inputfig{fig-df+-instruction.pdf_t}
\end{center}
...
\begin{figure}
\begin{center}
\inputfig{fig-df-mul-instruction.pdf_t}
\end{center}
\caption{\label{fig-df-*-instruction}
\texttt{df-*-instruction}.}
\end{figure}
...
\begin{figure}
\begin{center}
\inputfig{fig-df-div-instruction.pdf_t}
\end{center}
\caption{\label{fig-df-/-instruction}
\texttt{df-/-instruction}.}
\end{figure}
...
\refFig{fig-lf-+-instruction} shows the Graphviz illustration of the
\texttt{lf-+-instruction}

\begin{figure}
\begin{center}
\inputfig{fig-lf+-instruction.pdf_t}
\end{center}
...
\begin{figure}
\begin{center}
\inputfig{fig-lf-mul-instruction.pdf_t}
\end{center}
\caption{\label{fig-lf-*-instruction}
\texttt{lf-*-instruction}.}
\end{figure}
...
\begin{figure}
\begin{center}
\inputfig{fig-lf-div-instruction.pdf_t}
\end{center}
\caption{\label{fig-lf-/-instruction}
\texttt{lf-/-instruction}.}
\end{figure}
