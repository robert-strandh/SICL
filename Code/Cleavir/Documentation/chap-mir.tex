...
If the first output is chosen, then the output is
the sum of the two inputs.  

If the second output is chosen, then in order to obtain the sum of the
...
If the second output is chosen, then in order to obtain the difference
