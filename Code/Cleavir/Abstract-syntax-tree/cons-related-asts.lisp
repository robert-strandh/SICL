...
(defclass car-ast (read-ast-mixin cons-access-ast) ())
...
(defclass cdr-ast (read-ast-mixin cons-access-ast) ())
...
(defclass rplaca-ast (write-ast-mixin cons-access-ast) ())

(defun make-rplaca-ast (cons-ast value-ast &key origin (policy *policy*))
...
(defclass rplacd-ast (write-ast-mixin cons-access-ast) ())

(defun make-rplacd-ast (cons-ast value-ast &key origin (policy *policy*))
