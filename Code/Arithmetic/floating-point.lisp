...
(defmethod decode-float ((float single-float))
  (buoy:decode-single-float float))

(defmethod decode-float ((float double-float))
  (buoy:decode-double-float float))
