...
(define-condition attempt-to-access-default-initargs-of-forward-referenced-class
  ...
  (:report (lambda (condition stream)
             (format stream
                     "An attempt was made to access the default initargs~@
                      of the class:~@
                      ~s~@
                      which is a forward-referenced class."
                     (offending-class condition)))))
...
(define-condition attempt-to-access-effective-slots-of-forward-referenced-class
  ...
  (:report (lambda (condition stream)
             (format stream
                     "An attempt was made to access the effective slots~@
                      of the class:~@
                      ~s~@
                      which is a forward-referenced class."
                     (offending-class condition)))))
...
(define-condition superclass-must-be-a-class-metaobject
  ...
  (:report (lambda (condition stream)
             (format stream
                     "A superclass must be a class metaobject,~@
...
(define-condition no-such-method-class
  ...
  (:report (lambda (condition stream)
             (format stream
                     "The name:~@
                      ~s~@
                      was given as a method class, but there~@
                      is no method class with that name."
                     (method-class-name condition)))))
