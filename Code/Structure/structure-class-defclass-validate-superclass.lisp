...
(defmethod closer-mop:validate-superclass ((class structure-class) (superclass (eql (find-class 't))))
  ;; T is not a valid direct superclass, all structures inherit from STRUCTURE-OBJECT.
  nil)

(defmethod closer-mop:validate-superclass ((class structure-class) (superclass (eql (find-class 'standard-object))))
