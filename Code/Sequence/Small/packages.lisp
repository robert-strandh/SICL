...
(defpackage #:sicl-sequences-small-test
    (:shadowing-import-from #:sicl-sequences-small .
                            #.(package-shadowing-symbols '#:sicl-sequences-small))
    (:use #:sicl-sequences-small #:cl #:lisp-unit))
